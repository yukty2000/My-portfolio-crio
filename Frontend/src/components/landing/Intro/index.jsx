...
import { greeting, greetingDescription, linkedinUrl, githubUrl, cvLink, cflink, leetlink, cheflink} from 'data/config';
...
import codeforces from 'assets/illustrations/codeforces.png';
import leetcode from 'assets/illustrations/leetcode.png';
import codechef from 'assets/illustrations/codechef.jpg';
      ...
      <IntroWrapper as={Container}>
        <Details theme={theme}>
          ...
          <div className="social">
            ...
            <a href={cflink} target="_blank" rel="noreferrer">
              <img width="45" src={codeforces} alt="Codeforces" />
            </a>
            <a href={leetlink} target="_blank" rel="noreferrer">
              <img width="45" src={leetcode} alt="Leetcode" />
            </a>
            <a href={cheflink} target="_blank" rel="noreferrer">
              <img width="45" src={codechef} alt="Codechef" />
            </a>
          </div>
        </Details>
        <Thumbnail>
